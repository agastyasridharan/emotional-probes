# All 171 emotions from the Anthropic paper
# "Emotion Concepts and their Function in a Large Language Model" (April 2026)
EMOTIONS = [
    "afraid",
    "alarmed",
    "alert",
...
# All 100 topics from the Anthropic paper appendix
TOPICS = [
...
# Number of stories per emotion/topic combination (matching the paper)
