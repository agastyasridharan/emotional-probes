"""The 100 seed topics for story / dialogue generation, copied verbatim from the
paper's appendix ("Dataset generation", pp. 82-85).

These are deliberately *valence-ambiguous* life events: the same premise (e.g.
"A tenant receives an eviction notice") can plausibly be paired with almost any
target emotion, which isolates emotion as the manipulated variable rather than
the situation.
"""
...
assert len(set(TOPICS)) == 100, "topic list contains duplicates"
